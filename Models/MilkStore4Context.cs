...
public partial class MilkStore4Context : DbContext, IDataProtectionKeyContext
{
    ...
    // ← THÊM: lưu Data Protection key vào PostgreSQL, tránh mất key sau redeploy Render
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CartItem>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.CartItems)
                .HasForeignKey(d => d.ProductId).HasConstraintName("FK_CartItems_Products");
            entity.HasOne(d => d.User).WithMany(p => p.CartItems)
                .HasForeignKey(d => d.UserId).HasConstraintName("FK_CartItems_Users");
        });
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.OrderDate).HasDefaultValueSql("now()").HasColumnType("timestamptz");
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.OrderItems)
                .HasForeignKey(d => d.OrderId).HasConstraintName("FK_OrderItems_Orders");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.Brand).WithMany(p => p.Products)
                .HasForeignKey(d => d.BrandId).OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasNoKey().ToView("vw_CustomerStats");
            entity.Property(e => e.Email).HasMaxLength(150);
            entity.Property(e => e.FullName).HasMaxLength(150);
        ...
        {
            entity.HasNoKey().ToView("vw_OrderDetails");
        ...
        {
            entity.HasNoKey().ToView("vw_ProductStats");
